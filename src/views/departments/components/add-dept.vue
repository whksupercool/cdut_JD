<template>
    ...
    <el-dialog :title="showTitle" :visible="showDialog" @close="btnCancel">
        ...
        <el-form ref="deptForm" :model="formData" :rules="rules" label-width="20%">
...
<script>
import { getDepartmentsAPI, addDepartmentsAPI, getDepartDetailAPI, updateDepartmentsAPI } from '@/api/departments'
            ...
            this.$refs.deptForm.validate(async isOK => {
                if (isOK) {
                    ...
                    if (this.formData.id) {
                        ...
                        // 新增模式
                        await addDepartmentsAPI({ ...this.formData, pid: this.treeNode.id }) // 调用新增接口 添加父部门的id
                    }
                    // 表示可以提交了
